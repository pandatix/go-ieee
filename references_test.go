				...
				References: []goieeeapi.Reference{
					{
						...
						Title: "Persistent negative changes in seasonal greenness over different forest types of india using modis time series ndvi data (20012014)",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Persistent+negative+changes+in+seasonal+greenness+over+different+forest+types+of+india+using+modis+time+series+ndvi+data+%2820012014%29&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref1"),
					}, {
						Order: "2",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Improved+mapping+of+forest+type+using+spectral-temporal+landsat+features&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref2"),
					}, {
						Order: "3",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Assessment+of+an+operational+system+for+crop+type+map+production+using+high+temporal+and+spatial+resolution+satellite+optical+imagery&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref3"),
					}, {
						Order: "4",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=A+CNN-Based+Fusion+Method+for+Feature+Extraction+from+Sentinel+Data&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref4"),
					}, {
						Order: "5",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=SAR%2Fmultispectral+image+fusion+for+the+detection+of+environmental+hazards+with+a+gis&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref5"),
					}, {
						Order: "6",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Exploration+of+multitemporal+COSMO-skymed+data+via+interactive+tree-structured+MRF+segmentation&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref6"),
					}, {
						Order: "7",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Evaluation+of+multi-frequency+sar+images+for+tropical+land+cover+mapping&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref7"),
					}, {
						Order: "8",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=The+global+forest%2Fnon-forest+map+from+tandem-x+interferometric+SAR+data&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref8"),
					}, {
						Order: "9",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=High-resolution+forest+mapping+from+tandem-x+interferometric+data+exploiting+nonlocal+filtering&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref9"),
					}, {
						Order: "10",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Deep+residual+learning+for+image+recognition&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref10"),
					}, {
						Order: "11",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Densely+connected+convolutional+networks&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref11"),
					}, {
						Order: "12",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Target-adaptive+cnn-based+pansharpening&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref12"),
					}, {
						Order: "13",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Imagenet+classification+with+deep+convolutional+neural+networks&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref13"),
					}, {
						Order: "14",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=What+is+a+good+evaluation+measure+for+semantic+segmentation%3F&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref14"),
					}, {
						Order: "15",
						...
						GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Adam%3A+A+method+for+stochastic+optimization&as_occt=title&hl=en&as_sdt=0%2C31",
						RefType:           str("biblio"),
						ID:                str("ref15"),
					},
				},
