					...
					IEEE: []goieeeapi.Reference{
						{
							...
							GoogleScholarLink: "https://scholar.google.com/scholar?as_q=Edge+Preserving+Cnn+Sar+Despeckling+Algorithm&as_occt=title&hl=en&as_sdt=0%2C31",
