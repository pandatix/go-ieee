...
func checkErr(err, expErr error, t *testing.T) {
	...
	case *goieeeapi.ErrUnexpectedStatus:
		castedErr := err.(*goieeeapi.ErrUnexpectedStatus)
		castedExpErr := expErr.(*goieeeapi.ErrUnexpectedStatus)
...
var _ goieeeapi.HTTPClient = (*fakeHTTPClient)(nil)

func newFakeHTTPClient(body string, statusCode int, err error) goieeeapi.HTTPClient {
